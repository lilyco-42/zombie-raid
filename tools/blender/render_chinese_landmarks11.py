...
if __name__ == "__main__":
    shot("zhlm11_overview.png",
         ["stone_sheep", "stone_tiger", "stele_gallery", "stone_five_offering"], 12.0,
         (18, -30, 11), (18, 0, 2.2), 24.0, 0.40)
    shot("zhlm11_beasts.png", ["stone_sheep", "stone_tiger"], 4.0,
         (2, -9, 2.6), (2, 0, 0.9), 32.0, 0.44)
    shot("zhlm11_ritual.png", ["stele_gallery", "stone_five_offering"], 9.0,
         (4.5, -16, 5.0), (4.5, 0, 1.8), 30.0, 0.44)
    print("ZHLM11_PV_DONE")
