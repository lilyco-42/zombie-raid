...
if __name__ == "__main__":
    shot("zhlm8_overview.png",
         ["stone_pavilion", "wangzhu", "stone_bixi", "stone_censer"], 12.0,
         (18, -30, 11), (18, 0, 2.2), 24.0, 0.40)
    shot("zhlm8_pavilion.png", ["stone_pavilion"], 0.0,
         (0, -12, 4.5), (0, 0, 1.5), 32.0, 0.44)
    shot("zhlm8_monument.png", ["stone_bixi", "stone_censer"], 5.0,
         (4, -14, 4.0), (4, 0, 1.4), 30.0, 0.44)
    print("ZHLM8_PV_DONE")
