"""中式地标第六批预览: 石坊 / 石阶 / 石磨 / 石槽 (全框 + 生活级器物近景)。"""
import bpy, os, sys
...
if __name__ == "__main__":
    shot("zhlm6_overview.png",
         ["stone_arch", "stone_stair", "stone_mill", "stone_trough"], 12.0,
         (18, -30, 11), (18, 0, 2.4), 24.0, 0.40)
    shot("zhlm6_arch.png", ["stone_arch"], 0.0,
         (0, -14, 4.5), (0, 0, 2.4), 28.0, 0.44)
    shot("zhlm6_life.png", ["stone_mill", "stone_trough"], 3.0,
         (1.5, -8, 2.4), (1.5, 0, 0.9), 32.0, 0.46)
    print("ZHLM6_PV_DONE")
