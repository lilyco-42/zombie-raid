...
if __name__ == "__main__":
    shot("zhlm10_overview.png",
         ["stone_que", "stone_screen", "stone_horse", "stone_toad"], 12.0,
         (18, -30, 11), (18, 0, 2.2), 24.0, 0.40)
    shot("zhlm10_que.png", ["stone_que", "stone_screen"], 8.0,
         (4, -16, 5.0), (4, 0, 1.8), 30.0, 0.44)
    shot("zhlm10_beasts.png", ["stone_horse", "stone_toad"], 5.0,
         (2.5, -10, 3.0), (2.5, 0, 1.0), 32.0, 0.44)
    print("ZHLM10_PV_DONE")
